...
V(QA_Accepted_graph)$size = (degree(QA_Accepted_graph,mode = 'out')/10)+1.5
...
components = clusters (QA_Accepted_graph)$ membership
colours = sample (rainbow(max(components)+1))
V (QA_Accepted_graph)$color = colours[components +1]
